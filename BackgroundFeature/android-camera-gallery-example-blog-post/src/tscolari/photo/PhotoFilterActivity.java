...
@SuppressLint("NewApi") public class PhotoFilterActivity extends Activity {
    ...
    private void updateImageView(Bitmap newImage) {
    	...
    	this.imageView.setBackground(new BitmapDrawable(getResources(), this.image));
    }
     ...
     * @param data
     */
    @SuppressLint("NewApi") private void imageFromCamera(int resultCode, Intent data) {
